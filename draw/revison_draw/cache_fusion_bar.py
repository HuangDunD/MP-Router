...
def main():
    ...
    zipfian_data = [
        ("0.6",   [2.37,  2.22, 1.36,  1.83,  1.42, 0.88]),
        ("0.7",   [2.59,  2.41, 1.57,  2.18,  1.61, 0.99]),
        ("0.8",   [3.05,  2.85, 1.97,  2.57,  1.92, 1.15]),
        ("0.9",   [3.79,  3.62, 2.71,  3.41,  2.47, 1.33]),
        ("0.95",  [4.35,  4.16, 3.39,  4.04,  3.17, 1.33]),
    ]
    
    hotspot_data = [
        ("100%",   [2.21,  2.04, 1.33,  1.70,  1.34, 0.74]),
        ("10%",    [2.48,  2.30, 1.43,  1.95,  1.41, 0.85]),
