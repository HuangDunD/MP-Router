#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Plot Fig. 7 SmallBank throughput under uniform-hotspot distributions."""
...
def plot_grouped_bars(ax, data, systems, colors, hatches):
    ...
    ax.set_xlabel("Hot-Spot Fraction", fontsize=16)
...
def main() -> None:
    ...
    parser.add_argument("--data-module", default="extracted_data.fig7_uniform_hotspot")
    parser.add_argument("--outfile", type=Path, default=Path("figs") / "fig7_uniform_hotspot_bar.pdf")
    ...
    plot_grouped_bars(ax, revision_data.uniform_hotspot_data, systems, colors, hatches)
