...
def main():
    ...
    raw_data = [
        ("Random",        [4.76, 4.03, 3.1, 2.79]),
        ("Zipfian 0",     [4.76, 4.5, 3.26, 3.07]),
        ("Zipfian 0.3",   [4.27, 4.98, 2.9, 2.52]),
        ("Zipfian 0.6",   [5.11, 4.04, 3.2, 2.81]),
        ("Zipfian 0.7",   [5.3, 4.93, 3.39, 3.74]),
        ("Zipfian 0.8",   [5.59, 5.95, 4.14, 3.6]),
        ("Zipfian 0.9",   [11.55, 6.9, 12.76, 3.64]),
        ("Zipfian 0.95",  [19.79, 16.81, 18.6, 3.71]),
        ("Hotspot 0.1",   [4.18, 4.68, 3.25, 2.67]),
        ("Hotspot 0.01",  [5.29, 5.95, 3.67, 3.82]),
        ("Hotspot 0.001", [7.47, 7.39, 6.7, 5.76]),
    ]
