...
int main() {
    std::string selectSQL = "*** SELECT COUNT(*) FROM tpch.CUSTOMER WHERE CUSTOMER.c_custkey IN (103054, 9384, 101518, 97586, 10643, 100155, 104663, 101584, 106879, 102584);";
    std::string updateSQL = "*** UPDATE tpch.CUSTOMER ************* WHERE ps_partkey IN (732400, 752384, 707676,781470, 798267, 755211, 782611,745634, 791234, 727513);";
